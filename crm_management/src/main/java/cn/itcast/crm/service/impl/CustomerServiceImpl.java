...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public String findFixedByIdAndAddress(Integer id, String address) {
        String fixedAreaIdByIdAndAddress = customerRespository.findFixedAreaIdByIdAndAddress(id, address);
        return fixedAreaIdByIdAndAddress;
    }
}
